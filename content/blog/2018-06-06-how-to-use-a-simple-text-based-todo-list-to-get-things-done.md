...
and lets say that I want to keep a note to make [myMPD]({{< ref "2018-06-04-mympd-my-new-favorite-mpd-client" >}}) packages for [Archphile](http://archphile.org) . 
...
To set the first task as done (and archive it to **done.txt**):
